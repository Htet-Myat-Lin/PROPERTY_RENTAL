...
export const getAllProperties = asyncHandler(async (req, res, _next) => {
  ...
  if (req.query.page) filters.page = Number(req.query.page);
  if (req.query.limit) filters.limit = Number(req.query.limit);
  if (req.query.priceRange) filters.priceRange = JSON.parse(req.query.priceRange as string);
  ...
  if (req.query.propertyTypes) filters.propertyTypes = JSON.parse(req.query.propertyTypes as string);
  if (req.query.leaseTermMonths) filters.leaseTermMonths = Number(req.query.leaseTermMonths);
